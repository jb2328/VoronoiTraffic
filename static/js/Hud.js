...
class Hud {
    ...
    init(voronoi_viz, url_node) {
        ...
        if (url_node != '*') {
            ...
            let node = voronoi_viz.site_db.get_acp_id(voronoi_viz, url_node);
    ...
    get_zone_metadata(voronoi_viz, ZONE) {
        ...
        d3.selectAll('.metadata_zone')
            .on('click', function (d, i) {
                ...
                let highlighted_cell = voronoi_viz.site_db.get_acp_id(voronoi_viz, this.id.replace('META_ZONE_', ''));
